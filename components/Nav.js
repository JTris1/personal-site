...
function Hamburger({ className, navOpened, setNavOpened }) {
    ...
    return (
        <svg width={100} height={100} className={className} onClick={() => setNavOpened(!navOpened)}>
            ...
            />
            <path d="M20 50h60" className={`${line_style} fill-none stroke-neutral-950 dark:stroke-neutral-50 [stroke-dasharray:60_60] ${navOpened ? '[stroke-dasharray:0.0_60] [stroke-dashoffset:30]' : ''}`} />
            <path
